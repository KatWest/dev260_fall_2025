...
namespace Lab8_Sets
{
    ...
    public class SetOperationsLab
    {
        ...
        public HashSet<string> GetMissingPermissions(string userId, HashSet<string> requiredPermissions)
        {
            ...
            // int userPerms = userPermissions[userId].Count;
            // userPermissions[userId].UnionWith(requiredPermissions);
            // int newCount = userPermissions[userId].Count;
            // return newCount - userPerms;
        ...
        public HashSet<string> FindNewStudents()
        {
            ...
            // return entrolledNow.Except(enrolledLastQuarter).ToHashSet();
            return newStudents;
        ...
        public HashSet<string> FindDroppedStudents()
        {
            ...
            // return enrolledLastQuarter.Except(enrolledNow);
        ...
        public double CalculateRetentionRate()
        {
            ...
            return (double)(continuingStudents.Count / enrolledLastQuarter.Count) * 100.00;
